        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              "Welcome to BookBite: Revolutionizing the way you manage your restaurant with our all-in-one SaaS
              solution, designed to streamline operations and elevate your dining experience."
            </Text>
